...
public class MainClass {
    public static void main(String[] args) {
        ...
        // Слушатель (дисплей отображения информации).
        // Регистрация на отправителя происходит внутри класса CurrentDisplay.
        new CurrentDisplay(station);

        // Погодная станция начинает отправлять информацию:
        station.setMeasurements(29f, 65f, 745);
        station.setMeasurements(39f, 70f, 760);
        station.setMeasurements(42f, 72f, 763);
    }
}
